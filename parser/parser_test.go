...
func TestParseObject_Detail(t *testing.T) {
	Convey("测试解析对象", t, func() {
		...
		wantJson := `{"id":"id","title":"书名","type":"包装：平装、精装","pages":0,"pub_date":0,"publisher":"出版社","isbn":"图书编号","is_active":false,"pub_date_str":"出版日期","reviews":[{"id":"评论id","creation_unix":0,"book_id":"书籍id","content":"评论内容","reviewer":"评论人","recursive_reviews":[]}],"review_page":{"page":0,"page_size":0}}`
		So(string(obj.Json()), ShouldEqual, wantJson)
	})
}
