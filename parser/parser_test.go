...
var (
	...
	editDoc   = `{"Title":"新建或编辑书籍","Catalog":"测试文档/书籍/管理","Description":"","Remark":"","Order":"3","Request":{"Method":"post","Url":"{{BASEURL}}/api/v1/book/edit","Headers":[{"name":"Authorization","type":"string","require":"1","value":"bearer {{TOKEN}}","remark":"用户登录凭证"}],"ParamMode":"json","Params":[{"name":"id","type":"string","require":"0","value":"","remark":"id"},{"name":"title","type":"string","require":"1","value":"","remark":"书名"},{"name":"type","type":"string","require":"0","value":"","remark":"包装：平装、精装"},{"name":"pages","type":"int","require":"0","value":"0","remark":"页数"},{"name":"pub_date","type":"long","require":"0","value":"0","remark":"出版日期"},{"name":"publisher","type":"string","require":"0","value":"","remark":"出版社"},{"name":"isbn","type":"string","require":"0","value":"","remark":"图书编号"},{"name":"is_active","type":"boolean","require":"0","value":"false","remark":"是否激活"}],"ParamJson":"{\n    \"id\": \"id\",\n    \"title\": \"书名\",\n    \"type\": \"包装：平装、精装\",\n    \"pages\": 0,\n    \"pub_date\": 0,\n    \"publisher\": \"出版社\",\n    \"isbn\": \"图书编号\",\n    \"is_active\": false\n}"},"Response":{"Example":"{\n    \"errcode\": 0,\n    \"errmsg\": \"错误说明\"\n}","Params":[{"name":"errcode","type":"int","remark":"错误代码"},{"name":"errmsg","type":"string","remark":"错误说明"}]}}`
...
func TestParseObject_Detail(t *testing.T) {
	Convey("测试解析对象", t, func() {
		...
		wantJson := `{"id":"id","title":"书名","type":"包装：平装、精装","pages":0,"pub_date":0,"publisher":"出版社","isbn":"图书编号","is_active":false,"pub_date_str":"出版日期","reviews":[{"id":0,"creation_unix":0,"book_id":0,"content":"评论内容","reviewer":"评论人","recursive_reviews":[]}],"review_page":{"page":0,"page_size":0}}`
		So(string(obj.Json()), ShouldEqual, wantJson)
	})
}
